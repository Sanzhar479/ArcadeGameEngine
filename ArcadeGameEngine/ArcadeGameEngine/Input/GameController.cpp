...
{
	return static_cast<InputKey>(SDLK_j);
}
...
MouseInputAction GameController::GetMouseButtonActionForMouseButton(MouseButton mouseButton)
{
	for (const auto& buttonAction: mMouseButtonActions)
	{
		if (mouseButton == buttonAction.mouseButton)
		{
