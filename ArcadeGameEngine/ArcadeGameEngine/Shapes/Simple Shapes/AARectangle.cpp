...
bool AARectangle::Intersects(const AARectangle& otherRec) const
{
	return !(otherRec.GetBottomRightPoint().GetX() < GetTopLeftPoint().GetX() ||
		     otherRec.GetTopLeftPoint().GetX() > GetBottomRightPoint().GetX() ||
		     otherRec.GetBottomRightPoint().GetY() < GetTopLeftPoint().GetY() ||
		     otherRec.GetTopLeftPoint().GetY() > GetBottomRightPoint().GetY());
}
